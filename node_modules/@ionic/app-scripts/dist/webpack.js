...
var ionic_global_1 = require("./core/ionic-global");
...
function writeBundleFilesToDisk(context) {
    var mainJsPath = path_1.join(context.buildDir, context.outputJsFileName);
    var mainJsMapPath = path_1.join(context.buildDir, context.outputJsFileName + '.map');
    var mainJsFile = context.fileCache.get(mainJsPath);
    var mainJsMapFile = context.fileCache.get(mainJsMapPath);
    if (mainJsFile) {
        var ionicBundle = ionic_global_1.prependIonicGlobal(context, context.outputJsFileName, mainJsFile.content);
